# Modified by Bowen Cheng to compute Boundary PQ.
...
# match prediction and annotations. For cityscapes we assume that the 'image_id' has form
...
def pq_compute_single_core(proc_id, annotation_set, gt_folder, pred_folder, categories, iou_type, dilation_ratio):
    ...
    for gt_ann, pred_ann in annotation_set:
        ...
        # confusion matrix calculation for boundary
        if iou_type == "boundary":
...
def evaluatePanoptic(gt_json_file, gt_folder, pred_json_file, pred_folder, resultsFile, iou_type="segm", dilation_ratio=0.005):
...
def main():
    ...
    evaluatePanoptic(args.gtJsonFile, args.gtFolder, args.predictionJsonFile, args.predictionFolder, args.resultsFile, args.iou_type,
                     args.dilation_ratio)
