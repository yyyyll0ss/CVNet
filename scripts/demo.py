...
from CVNet.detector import get_pretrained_model
from CVNet.dataset.build import build_transform
from CVNet.utils.comm import to_single_device
from CVNet.utils.visualizer import show_polygons
...
def inference_with_patching(cfg, model, image, device):
    ...
    from CVNet.utils.polygon import generate_polygon, juncs_in_bbox
    from CVNet.utils.visualizer import viz_inria
