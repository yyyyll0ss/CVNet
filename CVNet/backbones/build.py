...
def build_hrnet48(cfg):
    ...
    model = HRNet48v2(cfg,
                      ...
                      num_class = num_class)
    pretrained = '/home/isalab301/yyl/VecCD/CVNet/backbones/hrnet_imagenet/hrnetv2_w48_imagenet_pretrained.pth'
...
def build_hrnet32(cfg):
    ...
    pretrained = 'CVNet/backbones/hrnet_imagenet/hrnetv2_w32_imagenet_pretrained.pth'
    model.init_weights(pretrained=pretrained)
...
def build_hrnet18(cfg):
    ...
    pretrained = '/home/isalab301/yyl/VecCD/CVNet/backbones/hrnet_imagenet/hrnetv2_w18_imagenet_pretrained.pth'
    model.init_weights(pretrained=pretrained)
