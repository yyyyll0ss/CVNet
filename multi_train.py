...
from CVNet.detector import CVNet
from CVNet.config import cfg
from CVNet.utils.comm import to_device
from CVNet.dataset import build_train_dataset_aug
...
def train(cfg):
    ...
    # build two datasets
    train_dataset_CD = build_train_dataset_aug(cfg)
    # CD dataloader
    ...
    for epoch in range(start_epoch + 1, arguments['max_epoch'] + 1):
        ...
        for it, (images, annotations) in enumerate(train_loader_CD):
